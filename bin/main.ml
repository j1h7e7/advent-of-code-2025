...
let solver : string -> string =
  ...
  | 3, 1 -> Advent_of_code.Day3.solve
  | 3, 2 -> Advent_of_code.Day3.solve2
  | 4, 1 -> Advent_of_code.Day4.solve
  | 4, 2 -> Advent_of_code.Day4.solve2
  | 5, 1 -> Advent_of_code.Day5.solve
  | 5, 2 -> Advent_of_code.Day5.solve2
  | 6, 1 -> Advent_of_code.Day6.solve
  | 6, 2 -> Advent_of_code.Day6.solve2
  | 7, 1 -> Advent_of_code.Day7.solve
  | 7, 2 -> Advent_of_code.Day7.solve2
  | 8, 1 -> Advent_of_code.Day8.solve
  | 8, 2 -> Advent_of_code.Day8.solve2
  | _ -> fun _ -> "N/A"
